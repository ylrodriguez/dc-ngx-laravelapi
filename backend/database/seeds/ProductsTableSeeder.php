...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $products = [
            ...
            [
                'name' => 'Celular Nokia 5 Octa Core 16Gb Ram 2Gb Cooper',
                'brand' => 'Nokia',
            ...
            [
                'name' => 'Celular Nokia 5 Oct 16 GB Ram 2 GB Dual Sim 4G Azul',
                'brand' => 'Nokia',
            ...
            [//15
                'name' => 'Celular Nokia 2 Android 7.1 8gb Dual Sim 4G NEGRO',
                'brand' => 'Nokia',
